...
task("deploy-revenue-buy-back")
    ...
    .setAction(async (taskArgs, hre) => {
        ...
        console.log(`Governor call SavingsManager.setRevenueRecipient to ${revenueRecipient.address} for zUSD and zBTC`)
        console.log(`Governor call setZassetConfig for zUSD and zBTC`)
    })
...
task("deploy-split-revenue-buy-back")
    ...
    .setAction(async (taskArgs, hre) => {
        ...
        console.log(`Governor call RevenueSplitBuyBack.mapBasset for zUSD and zBTC`)
        console.log(`Governor call SavingsManager.setRevenueRecipient to ${revenueRecipient.address} for zUSD and zBTC`)
    })
