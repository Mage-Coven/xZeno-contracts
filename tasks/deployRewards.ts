...
task("BoostDirector.deploy", "Deploys a new BoostDirector")
    ...
    .addOptionalParam(
        "vaults",
        "Comma separated list of vault underlying token symbols, eg zUSD,zBTC",
        "zUSD,zBTC,GUSD,BUSD,alUSD,HBTC,TBTC",
        types.string,
    )
...
task("Vault.deploy", "Deploys a vault contract")
    ...
    .addOptionalParam("stakingToken", "Symbol of staking token. eg MTA, BAL or zUSD", "MTA", types.string)
