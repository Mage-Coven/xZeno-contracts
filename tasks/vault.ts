...
subtask("vault-snap", "Dumps user data for a vault")
    ...
    .addOptionalParam("asset", "Symbol of the asset that has a xZeno vault. eg zUSD, alUSD, MTA", "zUSD", types.string)
...
subtask("vault-stake", "Stake into a vault")
    .addParam("asset", "Symbol of the asset that has a xZeno vault. eg zUSD, alUSD, MTA", undefined, types.string)
