...
describe("Liquidator", () => {
    ...
    before(async () => {
        ...
        const zassetDetails = await zAssetMachine.deployZasset(true)
        mockAAVE = zassetDetails.aavePlatformAddress
        bAssets = zassetDetails.bAssets
        pTokens = zassetDetails.pTokens
        sa = zAssetMachine.sa
