...
describe("StableMath", async () => {
    ...
    *************************************** */
    ...
    describe("calling mulRatioTruncate(x, ratio)", async () => {
        it("should calculate correct zAsset value from bAsset", async () => {
