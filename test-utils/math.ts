...
// How many zAssets is this bAsset worth using bAsset decimal length
...
// How many bAssets is this zAsset worth
export const applyRatioZassetToBasset = (input: BN, ratio: BN | string): BN => input.mul(ratioScale).div(ratio)

// How many zAssets is this bAsset worth
