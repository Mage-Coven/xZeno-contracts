...
contract CompoundIntegration is AbstractIntegration {
     ...
     * @param _lp               Address of liquidity provider. eg zAsset or feeder pool
    ...
    ****************************************/
    ...
    function approveRewardToken() external onlyGovernor {
        ...
        ZassetHelpers.safeInfiniteApprove(rewardToken, liquidator);
    ...
    ****************************************/
    ...
    function _withdraw(
        ...
        // Reason for skipping: to ensure that redeemZasset is always able to execute
    ...
    ****************************************/
    ...
    function reApproveAllTokens() external onlyGovernor {
        ...
        for (uint256 i = 0; i < bAssetCount; i++) {
            ...
            ZassetHelpers.safeInfiniteApprove(bAsset, cToken);
        }
    }
    ...
    function _abstractSetPToken(address _bAsset, address _cToken) internal override {
        ...
        ZassetHelpers.safeInfiniteApprove(_bAsset, _cToken);
    }
