...
// FLOWS
// 0 - fAsset/zAsset/mpAsset    -> FeederPool BoostedVault
// 1 - fAssets/zAssets/mpAssets -> FeederPool BoostedVault
contract FeederWrapper is Ownable {
    using SafeERC20 for IERC20;

    /**
     * @dev 0. fAsset/zAsset/mpAsset -> FeederPool BoostedVault
     * @param  _feeder             FeederPool address
     * @param  _vault              BoostedVault address (with stakingToken of `_feeder`)
     * @param  _input              Input address; fAsset, zAsset or mpAsset
    ...
    /**
     * @dev 1. fAssets/zAssets/mpAssets -> FeederPool BoostedVault
     * @param _feeder             FeederPool address
     * @param _vault              BoostedVault address (with stakingToken of `_feeder`)
     * @param _inputs             Input addresses; fAsset, zAsset or mpAsset
