...
contract MockSavingsContract is ERC20 {
        ...
        )
    {
        ...
        (creditsBurned, zassetRedeemed) = _redeem(_amount, _isCreditAmt, false);
        require(
            _isCreditAmt ? creditsBurned == _amount : zassetRedeemed == _amount,
            "Invalid output"
        );

        // Approve wrapper to spend contract's underlying; just for this tx
        // underlying.approve(unwrapper, zassetRedeemed);
