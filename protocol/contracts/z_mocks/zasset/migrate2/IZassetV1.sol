...
interface IZassetV1 {
    ...
    /** @dev Minting */
    function mint(address _basset, uint256 _bassetQuantity) external returns (uint256 zassetMinted);

    function mintTo(
        address _basset,
        uint256 _bassetQuantity,
        address _recipient
    ) external returns (uint256 zassetMinted);
    ...
    function redeem(address _basset, uint256 _bassetQuantity)
        external
        returns (uint256 zassetRedeemed);

    function redeemTo(
        address _basset,
        uint256 _bassetQuantity,
        address _recipient
    ) external returns (uint256 zassetRedeemed);
    ...
    function redeemZasset(uint256 _zAssetQuantity, address _recipient) external;
