...
contract RenWrapper {
    ...
    address public immutable zAsset;
    ...
    constructor(address _zAsset, address _gatewayRegistry) {
        require(_zAsset != address(0), "Invalid zAsset address");
        zAsset = _zAsset;
    ...
    function depositAndMint(
        ...
        uint256 mintedAmount = IGatewayRegistry(gatewayRegistry).getGatewayBySymbol("BTC").mint(
            pHash,
            _amount,
            _nHash,
            _sig
