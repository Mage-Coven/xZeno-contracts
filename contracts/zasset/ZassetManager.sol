 ...
 * @title   Manager
 * @author  xZeno
 * @notice  Simply contains logic to perform Basket Manager duties for an zAsset.
 *          Allowing logic can be abstracted here to avoid bytecode inflation.
 * @dev     VERSION: 1.0
 *          DATE:    2021-01-22
 */
library ZassetManager {
     ...
     *      amount of zAsset and sending it over to the SavingsManager.
