...
interface ISavingsContractV2 {
    ...
    function underlying() external view returns (IERC20 underlyingZasset); // V2
}
...
{
    // DEPRECATED but still backwards compatible
    function redeem(uint256 _amount) external returns (uint256 zassetReturned); // V1  (use IERC4626Vault.redeem)
