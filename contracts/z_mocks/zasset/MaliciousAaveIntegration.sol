...
contract MaliciousAaveIntegration is IPlatformIntegration, ImmutableModule {
    ...
    ****************************************/
     ...
     *      (zAsset and corresponding BasketManager)
     * @param _bAsset              Address for the bAsset
    ...
    function withdraw(
        ...
        _withdraw(_receiver, _bAsset, _amount, _totalAmount, _isTokenFeeCharged);
    }
    ...
    function withdraw(
        ...
        _withdraw(_receiver, _bAsset, _amount, _amount, _isTokenFeeCharged);
    }
    ...
    ****************************************/
    ...
    function reApproveAllTokens() external onlyGovernor {
        ...
        for (uint256 i = 0; i < bAssetCount; i++) {
            ZassetHelpers.safeInfiniteApprove(bAssetsMapped[i], lendingPoolVault);
        }
    }
    ...
    function _abstractSetPToken(
        ...
        // approve the pool to spend the bAsset
        ZassetHelpers.safeInfiniteApprove(_bAsset, lendingPool);
    }
