...
library StableMath {
    ...
    /**
     * @notice Token Ratios are used when converting between units of bAsset, zAsset and ZENO
    ...
    InitializableModule2
{
    ...
    ****************************************/
    ...
    function redeem(uint256 _credits) external returns (uint256 zassetReturned) {
     ...
     */
    function redeemCredits(uint256 _credits) external returns (uint256 zassetReturned) {
        require(_credits > 0, "Must withdraw something");
