    ...
    IERC4626Vault // V4
{
    ...
    function redeem(uint256 _amount) external returns (uint256 zassetReturned);
...
library StableMath {
    ...
    /**
     * @dev Token Ratios are used when converting between units of bAsset, zAsset and ZENO
     * Reasoning: Takes into account token decimals, and difference in base unit (i.e. grams to Troy oz for gold)
     * bAsset ratio unit for use in exact calculations,
     * where (1 bAsset unit * bAsset.ratio) / ratioScale == x zAsset unit
     */
    ...
    ****************************************/
     ...
     *      i.e. How much zAsset is this bAsset worth?
    ...
    function mulRatioTruncateCeil(uint256 x, uint256 ratio) internal pure returns (uint256) {
        // e.g. How much zAsset should I burn for this bAsset (x)?
        // 1e18 * 1e8 = 1e26
     ...
     *      i.e. How much bAsset is this zAsset worth?
...
library YieldValidator {
     ...
     * @param _newSupply               New total supply of the zAsset
 ...
 *          DATE:    2022-04-08
 */
contract SavingsContract_izusd_polygon_22 is
    ISavingsContractV4,
    Initializable,
    InitializableToken,
    ImmutableModule
{
    ...
    ****************************************/
        ...
        returns (uint256 creditsBurned)
    {
        ...
        (uint256 credits, uint256 zassetReturned) = _redeem(_underlying, false, true);
